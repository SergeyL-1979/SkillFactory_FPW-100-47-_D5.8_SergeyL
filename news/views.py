...
# ==== Начало кода, где буде реализовано вывод постов авторизированого пользователя, который автор =========
class PostAuthorView(generic.ListView):
    """ Вьюшка позволяющая показывать все созданные посты авторизированого пользователя,
