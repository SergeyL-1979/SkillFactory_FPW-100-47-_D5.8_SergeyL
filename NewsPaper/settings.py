...
EMAIL_PORT = 587
EMAIL_HOST_USER = os.environ.get('host_user')  # ваш QQ Номер счета и код авторизации
EMAIL_HOST_PASSWORD = os.environ.get('host_pasw')
EMAIL_USE_TLS = True  # Здесь должно быть True, Иначе отправка не удалась
# EMAIL_FROM = 'skill@gmail.com'  # ваш QQ номер аккаунта
# DEFAULT_FROM_EMAIL = 'skill@gmail.com'
